...
+ (void)startMonitorWithVc:(UIViewController *)selfVc{
    if (!hudBar) {
        hudBar = [[YBLNetWorkHudBar alloc] initWithFrame:CGRectMake(0,[ShiPeiIphoneXSRMax isIPhoneX]?88:kNavigationbarHeight, YBLWindowWidth, kBottomBarHeight) selfVc:selfVc];
        [self showHudView];
    }
}
