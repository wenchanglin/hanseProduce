...
- (void)setViews
{
    ...
    self.pageV.pageIndicatorTintColor = [UIColor colorWithHexString:@"#CCCCCC"];// 设置非选中页的圆点颜色
    self.pageV.currentPageIndicatorTintColor = [UIColor colorWithHexString:@"#F36868"]; // 设置选中页的圆点颜色
    ...
    self.btn.hidden = YES;
    UIColor *topleftColor = [UIColor colorWithHexString:@"#D90000"];
    UIColor *bottomrightColor = [UIColor colorWithHexString:@"#990000"];
    UIImage *bgImg = [UIImage gradientColorImageFromColors:@[topleftColor, bottomrightColor] gradientType:GradientTypeLeftToRight imgSize:_btn.size];
    self.btn.backgroundColor = [UIColor colorWithPatternImage:bgImg];
    ...
    [self.btn setTitleColor:[UIColor colorWithHexString:@"#E0BE8D"] forState:UIControlStateNormal];
...
-(void)removeViewBtn:(UIButton *)sender
{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:@"showmoney" object:nil];
