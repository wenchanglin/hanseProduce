...
- (CGRect)frameOfPresentedViewInContainerView
{
    ...
    presentedViewControllerFrame.origin.y = (containerViewBounds.size.height - presentedViewContentSize.height) * 0.5;
...
- (void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext
{
    ...
    if (isPresenting) {
        ...
        toView.transform = CGAffineTransformScale(toView.transform, 0.01, 0.01);
    }
