...
//渐变色
+ (UIImage *_Nullable)gradientColorImageFromColors:(NSArray*_Nullable)colors gradientType:(GradientType)gradientType imgSize:(CGSize)imgSize;
