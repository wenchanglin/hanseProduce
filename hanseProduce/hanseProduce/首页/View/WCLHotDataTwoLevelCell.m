...
@implementation WCLHotDataTwoLevelCell
...
-(void)setupLayout
{
    ...
    [self.picImageView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.width.height.mas_equalTo(SCREEN_WIDTH/2-5);
    }];
...
-(void)setModel:(WCLHotDataModel *)model
{
...
-(UILabel *)NoLabel
{
    if (!_NoLabel) {
        ...
        _NoLabel.font=[UIFont fontWithName:@"PingFang SC" size:10];
        _NoLabel.textColor=[UIColor colorWithHexString:@"#F5AF24"];
        [self.backImageView addSubview:_NoLabel];
    }
    return _NoLabel;
}
