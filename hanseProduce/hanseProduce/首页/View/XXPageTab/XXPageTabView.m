...
-(void)setSelectedIndiactorColor:(UIColor *)selectedIndiactorColor
{
    _selectedIndiactorColor = selectedIndiactorColor;
    self.indicatorView.backgroundColor = _selectedIndiactorColor;
}
