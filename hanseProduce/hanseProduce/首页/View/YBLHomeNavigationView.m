...
- (void)createSubViews {
    ...
    if (_navigationType == NavigationTypeHome) {
        ...
        self.searchButton.frame = CGRectMake(54,[ShiPeiIphoneXSRMax isIPhoneX]?44:20+7, YBLWindowWidth - 54*2, 30);
        ...
        self.scanButton.frame = CGRectMake(5, [ShiPeiIphoneXSRMax isIPhoneX]?30:20, 44, 44);
        self.scanButton.centerY=self.searchButton.centerY;
        ...
        self.messageButton.centerY=self.searchButton.centerY;
...
//        self.layer.shadowPath = [self getShadowPath].CGPath;
        ...
        self.searchButton = [UIButton buttonWithType:UIButtonTypeCustom];
        self.searchButton.frame = CGRectMake(20,[ShiPeiIphoneXSRMax isIPhoneX]?44:20+7, YBLWindowWidth - 20*2, 30);
        self.searchButton.layer.cornerRadius = self.searchButton.height/2;
        self.searchButton.layer.masksToBounds = YES;
        [self addSubview:self.searchButton];
        self.scanButton = [UIButton buttonWithType:UIButtonTypeCustom];
